const CACHE='skmedkart-admin-offline-login-v6';
const ASSETS=['./','./index.html','./admin.js?v=offline-v6','./manifest.webmanifest'];
...
self.addEventListener('fetch',e=>{
  ...
  if(url.pathname.endsWith('/admin.js')){
    e.respondWith(fetch(new Request(e.request,{cache:'no-store'})).catch(()=>caches.match('./admin.js?v=offline-v6')));
    return;
  }

...
async function pdfBlob(b){
  ...
  ctx.fillStyle='#fff';ctx.font='16px Arial';ctx.fillText('Thank you for purchasing  |  Order through WhatsApp by using SKMedKART app',30,footerY+30);
  ctx.font='14px Arial';ctx.fillText('Your Health, Our Priority',30,footerY+54);
